...
function (_super) {
  ...
  User.prototype.setNewAge = function (newAge) {
    var age = parseInt(newAge);
    this.set({
      age: age
    });
  };
...
function (_super) {
  ...
  function UserForm() {
    ...
    _this.changeUserName = function () {
      var input = _this.parent.querySelector('input');

      if (input) {
        var name = input.value;

        _this.model.setNewName(name);
      }
    };

    _this.changeUserAge = function () {
      _this.model.setNewAge('10');
    };
